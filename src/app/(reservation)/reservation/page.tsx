// app/(reservation)/reservation/page.tsx
'use client';

import { Suspense } from 'react';
import { useSearchParams } from 'next/navigation';
// import ReservationServiceSelector from './_components/ReservationServiceSelector';
import ReservationStep1 from './_components/ReservationStep1';
import ReservationStep2 from './_components/ReservationStep2';
import ReservationStep3 from './_components/ReservationStep3';
import ReservationStep4 from './_components/ReservationStep4';
import ReservationServiceSelector from './_components/ReservationServiceSelector';
// import ReservationStep3 from './_components/ReservationStep3';
// import ReservationStep4 from './_components/ReservationStep4';
...
function ReservationContent() {
  ...
  // If no service selected and no step, show service selector
  if (!serviceId && !step) {
    return <ReservationServiceSelector />;
  }

  // If service selected but no step, start at step 1
  if (serviceId && !step) {
