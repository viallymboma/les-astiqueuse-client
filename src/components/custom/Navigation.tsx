...
// import { useStore } from "@/store/useStore";
// import { Droplet, Home, Info, LogIn, Menu, Moon, Phone, Sparkles, Sun, X } from "lucide-react";
...
//       { id: 'services', label: 'Services', icon: Droplet },
...
//                       theme === 'dark'
//                         ? 'bg-gradient-to-r from-[#307aa8] to-[#185d88] text-white'
//                         : 'bg-gradient-to-r from-[#6eaad0] to-[#307aa8] text-white'
//                     }`}
//                   >
//                     Mon Espace
//                   </button>
...
//                       }}
//                       className={`w-full px-5 py-3 rounded-xl font-medium ${
//                         theme === 'dark' ? 'text-[#b2d2e6] hover:bg-white/10' : 'text-[#6d89a3] hover:bg-[#6eaad0]/10'
//                       }`}
//                     >
//                       Connexion
//                     </button>
...
//                 <button
//                   onClick={() => setTheme(theme === 'light' ? 'dark' : 'light')}
//                   className={`w-full px-5 py-3 rounded-xl font-medium flex items-center justify-center space-x-2 ${
//                     theme === 'dark'
//                       ? 'bg-[#307aa8] text-[#b2d2e6]'
//                       : 'bg-[#b2d2e6] text-[#307aa8]'
//                   }`}
//                 >
//                   {theme === 'light' ? <Moon className="w-5 h-5" /> : <Sun className="w-5 h-5" />}
